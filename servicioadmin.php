...
<head>
    ...
    <title>Servicio | Admin | Españoles en Edimburgo</title>
			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					...
					while($row3 = $results3->fetch_assoc()) {
						...
						echo ' <a href="delservice.php?id='.$v1.'"><button name="eliminar" type="button" class="boton">Eliminar</button></a>';
						echo ' <a href="editservice.php?id='.$v1.'"><button name="edit" type="button" class="boton">Editar</button></a>';
					?>
				</div>
			</div>
		</div>
