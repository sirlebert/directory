	...
	<section>
		<div class="container">
			<div class="row">
				...
				?>
				Recuerda comprobar la carpeta Spam, puede que tengas mensajes alli.<br>
				...
				<div class="left-sidebar">
					<h2>Otros</h2>
					<?php
						echo '<a href="comprobar.php"><button name="edit" type="button" class="boton">Eliminar Usuario y Servicios</button></a>';
					?>
				</div>
			</div>
		</div>
