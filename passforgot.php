					...
					<div class="row">
						<div class="col-sm-4 col-sm-offset-1">
							<div class="login-form">
								...
								<form name="login" action="recordpassforgot.php" method="post">
								<?php
									echo '<input name="id" type="hidden" placeholder="Contraseña" value="'.$id.'" required/>';
									
									echo '<input name="code" type="text" placeholder="Codigo" value="'.$code.'" required/>';
									?>
